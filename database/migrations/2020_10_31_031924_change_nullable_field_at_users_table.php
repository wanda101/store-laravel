...
class ChangeNullableFieldAtUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            $table->longText('adderss_one')->nullable()->change();
            $table->longText('adderss_two')->nullable()->change();
            $table->integer('povince_id')->nullable()->change();
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            $table->longText('adderss_one')->nullable(false)->change();
            $table->longText('adderss_two')->nullable(false)->change();
            $table->integer('povince_id')->nullable(false)->change();
